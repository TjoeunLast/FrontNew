...
export default function ProfileEditScreen() {
  ...
  return (
    <View style={s.page}>
      <ShipperScreenHeader title="프로필 수정" onPressBack={goBack} />
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        <View style={s.card}>
          <Text style={s.label}>이름</Text>
          <TextInput value={name} onChangeText={setName} style={s.input} placeholder="이름 입력" placeholderTextColor={c.text.secondary} />
